(function($) {
    $(document).ready(function() {
       ...
       /* =================================
        ...
        ===  Minimal Menu                 ====
        =================================== */
        // NOTE: minimal-menu setup is handled by navbar.js after it injects
        // the navbar HTML, to avoid running before the nav exists in the DOM.
        // We expose a helper so navbar.js can call it.
        window._initMinimalMenu = function() {
            var $menu = $('.minimal-menu');
            if (!$menu.length) return;
            // Clean up any duplicate injected elements first
        ...
        // Run immediately in case nav already exists (non-navbar.js pages)
        if ($('.minimal-menu').length) { window._initMinimalMenu(); }
        /* =================================
        ===  Fancy Select                 ====
        =================================== */
        ...
        =================================== */
        $(window).on('load', function() {
            // NOTE: carousel-1 and carousel-2 are intentionally skipped here.
            // They are initialized by index-products.js AFTER dynamic products
            // are loaded, to ensure correct autoHeight and content.
            // All other carousels are initialized below as normal.
